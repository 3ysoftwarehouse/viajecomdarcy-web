...
class ReservaPassageiro(models.Model):
    ...
    id_pacote = models.ForeignKey('pacote.Pacote', on_delete=models.DO_NOTHING, null=True)
    ...
    reserva_passageiro_preco =  models.DecimalField(max_digits=10, decimal_places=2, null=True)
    id_moeda = models.ForeignKey('moeda.Moeda', on_delete=models.DO_NOTHING, null=True)
    reserva_passageiro_cambio = models.DecimalField(max_digits=5, decimal_places=4, null=True)
    reserva_passageiro_obs = models.CharField(max_length=200, null=True)
    id_acomodacao_pacote = models.ForeignKey('acomodacao.Acomodacao', on_delete=models.DO_NOTHING, null=True)
    ...
    preco_acomodacao = models.DecimalField(max_digits=14, decimal_places=2, null=True)
    passageiro_opcional = models.ManyToManyField('venda.PassageiroOpcional', null=True)
